 ...
 */
public class CourseDetailActivity_ori extends SwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_detail_ori);
        ButterKnife.bind(this);
        context = CourseDetailActivity_ori.this;
        initData();
        initView();
        loadData();
    }
